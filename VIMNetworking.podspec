...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/vimeo/VIMNetworking.git", :branch => "cocoapods" }
  ...
  s.dependency "VIMObjectMapper", :git => 'https://github.com/vimeo/VIMObjectMapper.git', :branch => 'cocoapod'
